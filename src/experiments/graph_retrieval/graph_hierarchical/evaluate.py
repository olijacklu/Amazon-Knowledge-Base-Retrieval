...
def main():
    parser = argparse.ArgumentParser(description='Evaluate graph+hierarchical KB')
    ...
    evaluate_kb(kb_ids_file, args.output_dir, 'GRAPH + HIERARCHICAL', args.qas_dir, args.md_dir)
